...
import com.blog.my.website.constant.WebConst;
import com.blog.my.website.controller.admin.AttachController;
import com.blog.my.website.dao.AttachVoMapper;
import com.blog.my.website.dao.CommentVoMapper;
import com.blog.my.website.dao.ContentVoMapper;
import com.blog.my.website.dao.MetaVoMapper;
...
import com.blog.my.website.modal.Bo.ArchiveBo;
import com.blog.my.website.modal.Bo.BackResponseBo;
import com.blog.my.website.modal.Bo.StatisticsBo;
import com.blog.my.website.modal.Vo.*;
import com.blog.my.website.service.ISiteService;
import com.blog.my.website.utils.DateKit;
import com.blog.my.website.utils.TaleUtils;
import com.blog.my.website.utils.ZipUtils;
import com.blog.my.website.utils.backup.Backup;
    ...
    public List<ArchiveBo> getArchives() {
        ...
        if (null != archives) {
            archives.forEach(archive -> {
                ContentVoExample example = new ContentVoExample();
                ContentVoExample.Criteria criteria = example.createCriteria().andTypeEqualTo(Types.ARTICLE.getType()).andStatusEqualTo(Types.PUBLISH.getType()).andIsDeleteEqualTo(0);
                example.setOrderByClause("created desc");
