...
import com.blog.my.website.modal.Vo.OptionVo;
...
import com.blog.my.website.utils.GsonUtils;
 ...
 */
@Controller
@RequestMapping("/admin/rabbish")
public class RabbishController extends BaseController {
    private static final Logger LOGGER = LoggerFactory.getLogger(RabbishController.class);
