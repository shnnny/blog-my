...
//	}
    ...
    public static void main(String[] args) {
        ...
        Address4IP addressByIp = getAddressByIp(ip);
    ...
    public static  Address4IP getAddressByIp( String ip) {
        ...
        Map<String, Map<String, Object>> stringMapMap = JacksonUtil.JsonToMap(json_result);

        String country = (String)stringMapMap.get("data").get("country");
        String region = (String)stringMapMap.get("data").get("region");
        String city = (String)stringMapMap.get("data").get("city");
        String county = (String)stringMapMap.get("data").get("county");
        String isp = (String)stringMapMap.get("data").get("isp");
        String area =(String)stringMapMap.get("data").get("area");

        Address4IP address4IP = new Address4IP();

        address4IP.setRegion(region);
        address4IP.setIsp(isp);
        address4IP.setCounty(county);
        address4IP.setCountry(country);
        address4IP.setCity(city);
        address4IP.setArea(area);
